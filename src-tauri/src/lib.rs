...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::elevenlabs::elevenlabs_create_voice,
            commands::elevenlabs::elevenlabs_list_voices,
            commands::elevenlabs::elevenlabs_save_last_recording,
            commands::elevenlabs::elevenlabs_get_last_recording,
